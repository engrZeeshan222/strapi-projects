  ...
  async scrapping(brand, colors, fabricList, sizesList, classification) {
    try {
      ...
      selector(collection).each(async (i, element) => {
        ...
        if (link === "https://www.limelight.pk/collections/shirt") {
          ...
          link === "https://www.limelight.pk/collections/short-kurti"
        ) {
          await this.collectionScrapping(
            link,
            brand,
        ...
        } else if (link === "https://www.limelight.pk/collections/suits") {
          await this.collectionScrapping(
            link,
            brand,
            colors,
        ...
        } else if (link === "https://www.limelight.pk/collections/trousers-1") {
          await this.collectionScrapping(
            link,
            brand,
            colors,
